                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-hover align-middle text-nowrap">
                            ...
                            <tbody>
                                <?php include "../../app.php";
                                include "../../actions/experience/showAll.php";
                                $no = 1;
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5%;"><a
                                            href="../../actions/experience/destroy.php?id=<?= $item->id ?>" onclick="return confirm('Apakah Anda Yakin?')" class="btn btn-danger mdi mdi-delete text-light"></a></td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
                        </table>
